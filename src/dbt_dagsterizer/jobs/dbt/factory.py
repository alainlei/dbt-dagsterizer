...
def _get_partitions_def(
    ...
    Args:
        partitions: Partition specification ("daily", "hourly", "monthly", "unpartitioned", None, etc.)
...
def _build_dbt_cli_job(
    job_spec,
    include_current_day_partition=None,
    include_current_hour_partition=None,
    include_current_month_partition=None,
    timezone=None,
):
